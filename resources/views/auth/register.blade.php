    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-white " style = "border:none">
                <div class="card-header bg-white"><h2 class = "text-dark" style = "color:#e21e13; text-align:center; padding-left: 10%;">Stwórz konto</h2></div>
                ...
                <div class="card-body bg-white">
                    <form method="POST" id="register" name="register" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <!-- Mobile add-->
                         <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right">{{ __('Numer telefonu') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password_confirmation" class="col-md-4 col-form-label text-md-right">{{ __('Potwierdź hasło') }}</label>
